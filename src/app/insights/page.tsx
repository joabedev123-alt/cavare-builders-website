...
export const metadata = {
  title: "Insights | Cavare Builders LLC",
  description: "Discover our insights and perspectives on construction and remodeling in South Florida.",
};
    ...
    <div className="pt-28 pb-20 bg-brand-marble min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        ...
        <div className="max-w-3xl mt-6">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl font-medium text-brand-black tracking-tight leading-[1.15] mb-6">
            Ideas, Trends and <br />
            <span className="italic font-normal text-brand-gold">Industry Visions.</span>
          </h1>

          <p className="text-base sm:text-lg text-brand-muted font-light leading-relaxed">
            Follow our analysis and perspectives on the civil construction, interior design, and architecture markets.
          </p>
        </div>
      </div>
      ...
      <section className="py-16 bg-white border-y border-brand-stone/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          <p className="text-lg text-brand-muted">New content will be published here soon.</p>
        </div>
      </section>
    </div>
  );
